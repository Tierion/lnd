...
func (*CancelInvoiceMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_invoices_692d6397dfdf89eb, []int{0}
}
...
func (*CancelInvoiceResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_invoices_692d6397dfdf89eb, []int{1}
}
...
func (*AddHoldInvoiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_invoices_692d6397dfdf89eb, []int{2}
}
...
func (*AddHoldInvoiceResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_invoices_692d6397dfdf89eb, []int{3}
}
...
func (*SettleInvoiceMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_invoices_692d6397dfdf89eb, []int{4}
}
...
func (*SettleInvoiceResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_invoices_692d6397dfdf89eb, []int{5}
}
...
func (*SubscribeSingleInvoiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_invoices_692d6397dfdf89eb, []int{6}
}
...
func init() {
	proto.RegisterFile("invoicesrpc/invoices.proto", fileDescriptor_invoices_692d6397dfdf89eb)
}

var fileDescriptor_invoices_692d6397dfdf89eb = []byte{
