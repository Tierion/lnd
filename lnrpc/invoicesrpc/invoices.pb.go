...
func (*CancelInvoiceMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_invoices_640807d2fd54d245, []int{0}
}
...
func (*CancelInvoiceResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_invoices_640807d2fd54d245, []int{1}
}
...
func (*AddHoldInvoiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_invoices_640807d2fd54d245, []int{2}
}
...
func (*AddHoldInvoiceResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_invoices_640807d2fd54d245, []int{3}
}
...
func (*SettleInvoiceMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_invoices_640807d2fd54d245, []int{4}
}
...
func (*SettleInvoiceResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_invoices_640807d2fd54d245, []int{5}
}
...
func (*SubscribeSingleInvoiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_invoices_640807d2fd54d245, []int{6}
}
...
func init() {
	proto.RegisterFile("invoicesrpc/invoices.proto", fileDescriptor_invoices_640807d2fd54d245)
}

var fileDescriptor_invoices_640807d2fd54d245 = []byte{
